...
temp_files_gcs = []
for m in range(3):
    temp_files_url += f'"https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2022-0{m+1}.parquet" '
    temp_files_gcs.append(f"raw/yellow_tripdata_2022-0{m+1}.parquet")
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"for url in {temp_files_url}; do wget $url -P {path_to_local_home}; done"
    )
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        destination_project_dataset_table=f"{PROJECT_ID}.{BIGQUERY_DATASET}.yellow_trip_data_jan_to_march_2022",
        bucket=BUCKET,
        source_objects=temp_files_gcs,
